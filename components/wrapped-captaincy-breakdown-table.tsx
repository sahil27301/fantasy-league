...
function renderRoleBadge(role: "captain" | "viceCaptain") {
  if (role === "captain") {
    return (
...
export function WrappedCaptaincyBreakdownTable({
  ...
  return (
    ...
    >
      <div className="grid grid-cols-[70px_1fr_84px] px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-white/55">
        <span>Window</span>
        <span>Player</span>
      ...
      <div className="space-y-1 px-2 pb-2">
        {breakdown.players.map((entry, index) => (
          <div
            ...
            className="grid grid-cols-[70px_1fr_84px] items-center rounded-lg border border-white/8 bg-white/[0.04] px-2 py-2 text-sm text-white/90 opacity-0"
            style={{
